...
import { animation, Item, Menu, PredicateParams, Separator, Submenu, theme } from 'react-contexify';
...
const ContextMenu = () => {
    ...
    const { sort, setSort, multiSelect, setMultiSelect, selectFiles, loggedIn } = useContext(IContext);
